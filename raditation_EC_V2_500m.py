...
#        linestyle=linests[3],label='SIM SRF Shortwave')
    line3=axs[ir,jc].plot(xdat[0:nt-1],rtoasw[0:nt-1],color=color_cycle[1],lw=wds[4],
        linestyle=linests[4],label=r'CERES')#[0:lcc-3])
...
#    ymajorFormatter = FormatStrFormatter('%1.1f') #设置y轴标签文本的格式 
    ...
    line4=axs[ir,jc].plot(xdat[0:nt-1],rstoasw[0:nt-1],color=color_cycle[3],lw=wds[5],
        linestyle=linests[5],label=r'CRM') # $r_{ts}$')
#ax0.set_title('Upward shorwave radiaiton at TOA '+ r' $W m^{-2}$',fontsize=16)
