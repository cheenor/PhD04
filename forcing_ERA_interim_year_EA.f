...
!      IXX(2) =  6;  IYY(2)=  5;  bslat(2)= 27.5; bslon(2)= 90.
      area(1)='PRD' 
      X1(1)  = 44;  X2(1) = 48;  Y1(1) = 30;     Y2(1)=  26
      IXX(1)=   5;  IYY(1)= 5 ;  bslat(1)=17.5;  bslon(1)=107.5
!     MLYR=Middle & Low reaches of Yangzi River  
      area(2)='MLYR'
      X1(2)  = 44  ; X2(2)= 48 ;  Y1(2)= 27;   Y2(2)=23
      IXX(2) = 5   ; IYY(2)=5  ;  bslat(2)=25 ; bslon(2)=107.5
!     NPC=North Plain of China
      area(3)='NPC'
      X1(3)  = 45 ; X2(3) = 49 ;  Y1(3)= 24 ;  Y2(3)=20
      IXX(3) =  5 ; IYY(3)= 5  ;  bslat(3)=32.5; bslon(3)=110
!     NEC  NorthEast of China
      area(4)='NEC'
      X1(4)  = 48 ; X2(4) = 52 ;  Y1(4) = 21 ;  Y2(4)=17 
      IXX(4) = 5  ; IYY(4)= 5  ; bslat(4)=40.;  bslon(4)=117.5
...
!-----------large scale forcing -------------------
     ...
     +      'Every six hour one data'
          write(12,'(33A,1X,30A)')'TimeID 17_levels_T_forcing(K/day)'
...
!        IF(K.LT.14) GO TO 900 ! the second level convert to zero
        IF(K.EQ.2 .AND. pres.LT.PM(K)) GO TO 900 ! the second level is not always zero
        IF(K.EQ.3 .AND. pres.LT.PM(K)) GO TO 900
