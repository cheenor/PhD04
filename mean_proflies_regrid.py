...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 22 11:25:12 2015
...
nameq1q2="ETP06_regrid.99"
nameforcing="ETP06_lsforcing_regrid.37"
#nameq1q2="NPC_regrid.99"
#nameforcing="NPC_lsforcing_regrid.37"
#################################
...
############forcing
ax1.set_ylim(0,16)           
ax1.plot(fcq1obs_pf,ydat,label=r'Temperature Forcing',
    c=colors[0],ls=sty[0],marker=mker[0],lw=width[0],) #q1sim
#allvar_mean[5,0]=0.
ax1.plot(fcq2obs_pf,ydat,label=r'Moiture Forcing',
    c=colors[1],ls=sty[1],marker=mker[1],lw=width[1],)  #q1sim
