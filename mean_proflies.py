...
#########################################################
#### forcing
fpath=dirq12+"ETP06_lsforcing.37"
onedim1=[]
linesplit=[]
f=open(fpath)
ff=f.readlines()  ## first line in obs file is legend 
...
ylabs='Height'+r' $km$'
ax0.set_ylabel(ylabs,fontsize=36)
ax0.legend()
#
plt.ylim(0,16)
plt.show()                     
plt.savefig(dirpic+casenm+'_qaqbqcqr_profiles.pdf')          
#plt.show()
plt.close() 
##############################
# Q1 and Q2
...
ax4.legend()
plt.show()                     
plt.savefig(dirpic+casenm+'_Q1Q2_profiles.pdf')          
#plt.show()
plt.close() 
...
ax4.set_ylabel(ylabs,fontsize=size_title)
plt.show()                     
plt.savefig(dirpic+casenm+'_Q1Q2_profiles_Composition.pdf')          
#plt.show()
plt.close() 
