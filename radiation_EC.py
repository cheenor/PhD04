...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 18 16:22:47 2015
...
fpath=filepath=dirceres+ceresnmtoa
onedim1=[]
linesplit=[]
f=open(fpath)
ff=f.readlines()[1:]  ## first line in obs file is legend 
...
lcc=len(ceresvrnm[3])
ax0.set_ylim(0,700)
ax0.plot(xdat[0:nt-1],ceresvar[3,0:nt-1],'g',label=ceresvrnm[3])#[0:lcc-3])
...
avg2=0.
for i in range(0,nt):
    avg1=avg1+ceresvar[12,i]
    avg2=avg2+simvar[1,i]
avg1=avg1/nt
avg2=avg2/nt 
avgstr1="%.2f"%avg1
avgstr2="%.2f"%avg2
lcc=len(ceresvrnm[12])
ax1.plot(xdat[0:nt-1],ceresvar[12,0:nt-1],'g',label=ceresvrnm[12])#[0:lcc-3])
...
lcc=len(ceresvrnm[7])
ax0.plot(xdat[0:nt-1],ceresvar[7,0:nt-1],'g',label=ceresvrnm[7])#[0:lcc-3])
...
ax.set_ylim(170,250)
ax.set_xlim(170,250)
plot(ceresvar[7,0:nt-1],simvar[2,0:nt-1],'bo')
...
###
fig,(ax0,ax1) = plt.subplots(nrows=2,ncols=1,figsize=(12,6))
lcc=len(ceresvrnm[16])
ax0.plot(xdat[0:nt-1],ceresvar[16,0:nt-1],'g',label=ceresvrnm[16])#[0:lcc-3])
...
avg2=0.
for i in range(0,nt):
    avg1=avg1+ceresvar[20,i]
    avg2=avg2+simvar[5,i]
avg1=avg1/nt
avg2=avg2/nt 
avgstr1="%.2f"%avg1
avgstr2="%.2f"%avg2
lcc=len(ceresvrnm[20])
ax1.plot(xdat[0:nt-1],ceresvar[20,0:nt-1],'g',label=ceresvrnm[20])#[0:lcc-3])
...
ax.set_ylim(260,430)
ax.set_xlim(260,430)
plot(ceresvar[24,0:nt-1],simvar[6,0:nt-1],'bo')
...
plt.show()
plt.close()
lcc=len(ceresvrnm[24])
fig,(ax0,ax1) = plt.subplots(nrows=2,ncols=1,figsize=(12,6))
ax0.plot(xdat[0:nt-1],ceresvar[24,0:nt-1],'g',label=ceresvrnm[24])#[0:lcc-3])
...
avg2=0.
for i in range(0,nt):
    avg1=avg1+ceresvar[28,i]
    avg2=avg2+simvar[7,i]
avg1=avg1/nt
avg2=avg2/nt 
avgstr1="%.2f"%avg1
avgstr2="%.2f"%avg2
lcc=len(ceresvrnm[28])
ax1.plot(xdat[0:nt-1],ceresvar[28,0:nt-1],'g',label=ceresvrnm[28])#[0:lcc-3])
...
ax.set_ylim(180,380)
ax.set_xlim(180,380)
plot(ceresvar[28,0:nt-1],simvar[7,0:nt-1],'bo')
