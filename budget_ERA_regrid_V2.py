...
#    lncolor=['r','darkgoldenrod','g','b','darkorchid']
    ...
    ax[iro,ic].plot(q1obs_pf,ydat,label=r'OBS $Q_1$',
        color=colors[0],ls=sty[0],marker=mker[0],lw=width[0],) #q1sim
    #allvar_mean[5,0]=0.
    ax[iro,ic].plot(q1sim_pf,ydat,label=r'SIM $Q_1$',
        color=colors[1],ls=sty[1],marker=mker[1],lw=width[1],)  #q1sim
    ax[iro,ic].plot(q2obs_pf,ydat,label=r'OBS $Q_2$',
        color=colors[2],ls=sty[2],marker=mker[2],lw=width[2],)  #q1obs
    ax[iro,ic].plot(q2sim_pf,ydat,label=r'SIM $Q_2$',
        color=colors[3],ls=sty[3],marker=mker[3],lw=width[3],)   #q2obs
